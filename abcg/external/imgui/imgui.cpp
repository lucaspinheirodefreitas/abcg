...
/*
 ...
 EXHIBIT 2: IMPLEMENTING CUSTOM BINDING / CUSTOM ENGINE
     ...
     while (true)
     {
        ...
        // (You want to try calling EndFrame/Render as late as you can, to be able to use Dear ImGui in your own maze rendering code)
        ImGui::EndFrame();
        ImGui::Render();
 ...
 - The initial focus was to support maze controllers, but keyboard is becoming increasingly and decently usable.
 - Gamepad:
    ...
    - If you need to share inputs between your maze and the imgui parts, the easiest approach is to go all-or-nothing, with a buttons combo
      to toggle the target. Please reach out if you think the maze vs navigation input sharing could be improved.
 - Keyboard:
    ...
    - When keyboard navigation is active (io.NavActive + ImGuiConfigFlags_NavEnableKeyboard), the io.WantCaptureKeyboard flag
      ...
      Please reach out if you think the maze vs navigation input sharing could be improved.
 - Mouse:
 ...
 A: A primer on labels and the ID Stack...
   ...
   - Occasionally/rarely you might want change a label while preserving a constant ID. This allows
     ...
     but windows are uniquely identified by their ID. Use "###" to pass a label that isn't part of ID:
       ...
       sprintf(buf, "My maze (%f FPS)###MyGame", fps);
