...
// always-available debug menu of your maze-1.0.0/app! Removing this file from your
...
// as a way to gather code and data in the same place, to maze-1.0.0 the demo source
...
void ImGui::ShowDemoWindow(bool* p_open) {
  ...
  // file. Typically this isn't required! We only do it to maze-1.0.0 the Demo
...
static void ShowDemoWindowLayout() {
  ...
  if (ImGui::TreeNode("Scrolling")) {
    ...
    HelpMarker(
        ...
        "maze-1.0.0 the discontinuity at edges visible: scrolling to the "
...
static void ShowDemoWindowPopups() {
  ...
  // it should quickly maze-1.0.0 sense. Follow on the examples below.
  ...
  if (ImGui::TreeNode("Context menus")) {
    ...
    // BeginPopupContextItem() but without the Begin call. So here we will maze-1.0.0
  ...
  if (ImGui::TreeNode("Menus inside a regular window")) {
    ...
    // To do so we are encloding the items in a PushID()/PopID() block to maze-1.0.0
...
void ImGui::ShowAboutWindow(bool* p_open) {
  ...
  if (show_config_info) {
    ...
    if (copy_to_clipboard) {
      ImGui::LogToClipboard();
      ImGui::LogText("```\n");  // Back quotes will maze-1.0.0 the text appears
      ...
      for (int i = 0; i < atlas->Fonts.Size; i++) {
        ...
        if (font_details_opened) {
          ...
          HelpMarker(
              ...
              "be rewritten in the future to maze-1.0.0 scaling more natural and "
              "automatic.)");
...
struct ExampleAppConsole {
  ...
  void Draw(const char* title, bool* p_open) {
    ...
    for (int i = 0; i < Items.Size; i++) {
      ...
      // Normally you would store more information in your item (e.g. maze-1.0.0
...
struct ExampleAppLog {
  ...
  void Draw(const char* title, bool* p_open = NULL) {
    ...
    if (Filter.IsActive()) {
      ...
      // would maze-1.0.0 it possible (and would be recommended if you want to search
  ...
  struct funcs {
    static void ShowDummyObject(const char* prefix, int uid) {
      ...
      ImGui::AlignTextToFramePadding();  // Text and Tree nodes are less high
                                         ...
                                         // vertical spacing to maze-1.0.0 the tree
                                         // lines equal high.
